...
/*#define SUPPORTED_USE_DUAL_FW_WITH_LCDID*/
#if defined(SUPPORTED_USE_DUAL_FW)
#include "zinitix_bt541_firmware_00.h"
#include "zinitix_bt541_firmware_01.h"
u8 *m_firmware_data;
#elif defined(SUPPORTED_USE_DUAL_FW_WITH_LCDID)
#include "zinitix_bt541_firmware_CPT.h"
#include "zinitix_bt541_firmware_BOE.h"
u8 *m_firmware_data;
#else
...
#elif defined(SUPPORTED_USE_DUAL_FW_WITH_LCDID)
#define TSP_TYPE_COUNT	2
u8 *m_pFirmware[TSP_TYPE_COUNT] = {(u8 *)m_firmware_data_CPT, (u8 *)m_firmware_data_BOE,};
u8 m_FirmwareIdx = 0;
#define CHECK_HWID				0
static void bt541_firmware_check_with_LCD_ID(void);
#else
#define CHECK_HWID				0
#endif
...
#ifdef  SUPPORTED_USE_DUAL_FW_WITH_LCDID
static void bt541_firmware_check_with_LCD_ID(void)
{
...
retry_init:
...
#endif
#ifdef  SUPPORTED_USE_DUAL_FW_WITH_LCDID
	bt541_firmware_check_with_LCD_ID();
#endif
	...
	if (write_reg(client, 0x2C, 50) != I2C_SUCCESS)
		goto fail_init;
